...
d2=tk.Button(root,text="Crop Prediction ",command=check_crop,width=20,height=2,bd=0,background="#17202A",foreground="white",font=("times new roman",14,"bold"))
d2.place(x=1100,y=350)


d3=tk.Button(root,text="Leaf Disease ",command=master_plant,width=20,height=2,bd=0,background="#17202A",foreground="white",font=("times new roman",14,"bold"))
